...
static int encode_type1045(rtcm_t *rtcm, int sync)
{
    ...
    unsigned int sqrtA,e;
    int i=24,prn,week,toe,toc,i0,OMG0,omg,M0,deln,idot,OMGd,crs,crc;
    int cus,cuc,cis,cic,af0,af1,af2,bgd1,oshs,osdvs; //bgd2; DK removed
    ...
    //bgd2 =ROUND(eph->tgd[1]/P2_32); /* E5b/E1 */  // DK, not used
    oshs =(eph->svh>>4)&3;
    osdvs=(eph->svh>>3)&1;
...
{
    double udint=0.0;
    int i,j,iod=0,nsat,prn,np,offp,dclk[3]; //,iode; // DK removed, not used
