...
// Includes for HYDRASDR SDR
#ifdef HYDRASDR
  #include "hydrasdrExterns.h"
  #include "hydrasdr.h"
#endif

// Includes for HACKRF SDR
#ifdef HACKRF
  #include "hackrf.h"
#endif
...
#define FEND_HYDRASDR 5                // front end type: HydraSDR
...
#define FEND_FHYDRASDR 11              // front end type: HydraSDR binary file
#define FEND_FHACKRF  12               // front end type: HackRF binary file
...
// EKF struct (varR used by WLS estimator)
typedef struct {
        double varR;
        double rk1_v[32];
} sdrekf_t;
